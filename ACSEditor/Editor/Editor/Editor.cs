...
using ACSEditor.Helper;
using NetSpell.SpellChecker;

using Pavonis.COM;
using Pavonis.COM.IOleCommandTarget;
using System.IO.Compression;
using ACSEditor.Properties;
using System.Text;
...
namespace ACSEditor
{
    ...
    public partial class Editor : UserControl, SearchableBrowser
    {
        ...
        bool Licresult = IronPdf.License.IsValidLicense("IRONPDF-49375960F4-720786-6BFD0A-2F308E1D40-7ECEEDDF-UEx60905F54E21F8D8-AMERICANCOLLEGEOFSURGEONS.IRO200326.7419.20147.ORG.5DEV.1YR.SUPPORTED.UNTIL.27.MAR.2021");
        bool is_licensed = IronPdf.License.IsLicensed;
        TextBox aptTextBox = new TextBox();
        public delegate void TickDelegate();
        string saveLocalPrefix = @"C:\Users\Public\Documents\";
        string saveLocation;
        ...
        public Editor()
        {
            ...
            spelling.ReplacedWord += new Spelling.ReplacedWordEventHandler(spelling_ReplacedWord);
            spelling.DeletedWord += new Spelling.DeletedWordEventHandler(spelling_DeletedWord);
        ...
        {
            if (tabMain.SelectedTab.Text == "tabPage1")
            {
...
private void insertHtml()
        ...
        {
            if (SelectionType != ACSEditor.SelectionType.Text) return false;
        ...
        public void SelectLink()
        {
            ...
            {
                case ACSEditor.SelectionType.Control:
                    {
                    ...
                    break;
                case ACSEditor.SelectionType.Text:
                    {
                        IHTMLTxtRange txtRange = (IHTMLTxtRange)doc.selection.createRange();
                        if (txtRange != null && !string.IsNullOrEmpty(txtRange.htmlText))
                        {
...
//						{
//							Debug.Assert(webBrowser1.Document != null, "wb.Document != null");
//							Debug.Assert(webBrowser1.Document.Body != null, "wb.Document.Body != null");
//#if VS2010
//                              wb.Document.Body.InnerHtml = ClearWord(BodyInnerHTML);
//#else
//                            webBrowser1.Document.Body.InnerHtml = ClearWordNoDefult(BodyInnerHTML, true, true, true);
//#endif
//						}
						break;
        ...
        private void tsbSpellCheck_Click(object sender, EventArgs e)
        {
			...
			//spelling.Text = webBrowser1.Document.Body.InnerHtml;
            //spelling.SpellCheck();
			doSpellCheck();
		}
        ...
        {
            System.Windows.Forms.TabControl.TabPageCollection collection = tabMain.TabPages;

            aptTextBox.Text = BodyHtml;

            if (tabMain.SelectedTab.Name == "tabPage1")
            {
                this.spelling.Text = aptTextBox.Text; 
        ...
        {
            int start = this.aptTextBox.SelectionStart;
            int length = this.aptTextBox.SelectionLength;

            this.aptTextBox.Select(e.TextIndex, e.Word.Length);
            // this.aptTextBox.SelectedText = "";
            // Replace selection with word from Replace With field

            this.aptTextBox.SelectedText = e.ReplacementWord;

            // Move selection point to next word
            if (start > this.aptTextBox.Text.Length)
                start = this.aptTextBox.Text.Length;
            if ((start + length) > this.aptTextBox.Text.Length)
                length = 0;
            this.aptTextBox.Select(start, length);
        }
        ...
        {
            CheckKey();
            saveLocation = saveLocalPrefix + "Test.pdf";
		...
		private void _cmdSelectField_Click(object sender, EventArgs e)
		{
            ...
            {
                MessageBox.Show("Not configured for Entity Fields, if you wish to use entity fields please set the Entity property in the properties window by designing in place.");
            }
        }
        public void SelectFields()
        {

            frmPickField frmPickField = new frmPickField();
            frmPickField.EId = eId;
            frmPickField.editField = editorF;
            frmPickField.SQL = fldSql;
            frmPickField.thiseditor = this;
            frmPickField.Show();
		...
		{
            Clipboard.SetText(DateTime.Now.ToLongDateString());
            if (Clipboard.ContainsText())
            {
                Paste();
            }
		...
		{
            Clipboard.SetText(DateTime.Now.ToLongTimeString());
            if (Clipboard.ContainsText())
            {
                Paste();
            }
        ...
        public static string ClearWordNoDefault(string sourceText, bool bIgnoreFont, bool bRemoveStyles, bool cleanWordKeepsStructure)
        {
		...
		private void tsbClearWord_Click(object sender, EventArgs e)
		{
            if (BodyInnerHTML != null)
            {
                ...
                Debug.Assert(webBrowser1.Document.Body != null, "wb.Document.Body != null");
                              ...
                              wb.Document.Body.InnerHtml = ClearWord(BodyInnerHTML);
#else
                webBrowser1.Document.Body.InnerHtml = ClearWordNoDefault(BodyInnerHTML, true, true, true);
#endif
            }
        ...
        public void WordCount()
        {
            //Debug.Assert(webBrowser1.Document != null, "wb.Document != null");
            //Debug.Assert(webBrowser1.Document.Body != null, "wb.Document.Body != null");
            var internalhtml = BodyInnerHTML;  
            int count = 0;
#if VS2010
...
#else
            if (!webBrowser1.Document.Body.InnerText.IsNull())
            {
                var sec = Regex.Split(webBrowser1.Document.Body.InnerText, @"\s");
...
#endif
            tsslWordCount.Text = string.Format("Word Count：{0}", count);
        }
		...
		private void linkButton_Click_1(object sender, EventArgs e)
		{
            SelectLink();
        }
		...
		private void outdentButton_Click_1(object sender, EventArgs e)
		{
            Outdent();
        }

		private void indentButton_Click_1(object sender, EventArgs e)
		{
            Indent();
        }

		private void tsbSuperscript_Click_1(object sender, EventArgs e)
		{
            Superscript();
        }

		private void tsbSubscript_Click_1(object sender, EventArgs e)
		{
            Subscript();
		}

		private void tsbPreview_Click_1(object sender, EventArgs e)
		{
            Preview();
        }
		...
		private void backColorButton_Click_1(object sender, EventArgs e)
		{
            SelectBackColor();
        }
	}
