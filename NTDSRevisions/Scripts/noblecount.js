...
(function ($) {
    ...
    **********************************************************************************/
    $.fn.NobleCount.settings = {
        ...
        // 		changes
        max_chars: 500, 		// maximum number of characters
    ...
    **********************************************************************************/
    ...
    function attach_nobility(t_obj, c_obj, c_settings, mc_passed) {
        ...
        //
        // NIALL - 11.01.2011: 
        // METHOD TO PREVENT USERS FROM PASTING TEXT GREATER THAN THE ALLOWABLE CHARACTER LIMIT.
        //
        $(t_obj).bind('paste', function (e) {
            ...
            setTimeout(
				function () {
				    ...
				    // If you wish to implement a check before the text area is populated you can use
