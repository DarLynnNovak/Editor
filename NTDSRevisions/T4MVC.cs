...
{
    public static App.Controllers.AccountController Account = new App.Controllers.T4MVC_AccountController();
    public static App.Controllers.HomeController Home = new App.Controllers.T4MVC_HomeController();
    public static App.Controllers.PersonSuggestionController PersonSuggestion = new App.Controllers.T4MVC_PersonSuggestionController();
    public static App.Controllers.UtilityController Utility = new App.Controllers.T4MVC_UtilityController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string noblecount_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/noblecount.min.js") ? Url("noblecount.min.js") : Url("noblecount.js");
        ...
        public static readonly string suggestions_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/suggestions.min.js") ? Url("suggestions.min.js") : Url("suggestions.js");
    }
    ...
    public static class Content {
        ...
        public static class images {
            ...
            public static readonly string NTDB_logo_gif = Url("NTDB-logo.gif");
        }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string errorhandler_js = "~/Scripts/errorhandler.js"; 
                ...
                public const string jquery_confirm_js = "~/Scripts/jquery.confirm.js"; 
                ...
                public const string noblecount_js = "~/Scripts/noblecount.js"; 
                ...
                public const string suggestions_js = "~/Scripts/suggestions.js"; 
            }
        }
